...
class UserActivity extends \yii\db\ActiveRecord
{
    ...
    const ACTION_TARGET_TYPE_CREDENTIAL = 6;
    const ACTION_TARGET_TYPE_DEVICE = 7;
    const ACTION_TARGET_TYPE_OTHER = 8;
    const ACTION_TARGET_TYPE_GROUP = 9;
    const ACTION_TARGET_TYPE_HOME = 10;



    public static $action_targets = [
        self::ACTION_TARGET_TYPE_USER => 'Người dùng',
        self::ACTION_TARGET_TYPE_CAT => 'Quản lý Danh mục / Add-on',
        ...
        self::ACTION_TARGET_TYPE_GROUP => 'Quản lý thể loại nội dung',
